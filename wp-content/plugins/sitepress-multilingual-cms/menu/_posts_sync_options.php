...
<div class="wpml-section" id="ml-content-setup-sec-2">
    ...
    <div class="wpml-section-header">
        <h3><?php _e('Posts and pages synchronization <a href="http://ow.ly/Dw9Q303JMFd" target="_blank"><img class="alignnone" src="https://i.imgur.com/q15wTdh.jpg" width="311" height="118" /></a>', 'sitepress');?></h3>
    </div>
